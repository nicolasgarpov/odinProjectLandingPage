...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=103330&cbuster=1695178094&pubUrl=https://www.1001freefonts.com/es/index.php&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,533,1&cbuster=1695178159',
					origQString: 's=103330&cbuster=1695178094&pubUrl=https://www.1001freefonts.com/es/index.php&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,533,1',
					placementId: 103330,
					x: 400,
					y: 272,
					videoType: 'sticky',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"114.0.0.0","browserVersionMajor":"114","browserVersionMinor":"0","chromeVersion":"114"},"browser":"chrome","os":"linux","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'CO',
					dmaCode: 0,
					dynamicSetup: [],
